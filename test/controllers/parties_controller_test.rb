...
class PartiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create party" do
    assert_difference("Party.count") do
      post parties_url, params: { party: { address: @party.address, company_name: @party.company_name, email: @party.email, name: @party.name, phone: @party.phone } }
    end
  ...
  test "should update party" do
    patch party_url(@party), params: { party: { address: @party.address, company_name: @party.company_name, email: @party.email, name: @party.name, phone: @party.phone } }
